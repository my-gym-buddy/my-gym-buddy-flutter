  ...
  void _showWorkoutRecoveryModal() async {
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) => AtsModal(
        ...
        message: 'It looks like your last workout session was interrupted. Would you like to resume where you left off or start a new session?',
        ...
        customContent: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('workout details:', style: Theme.of(context).textTheme.titleSmall),
              const SizedBox(height: 10),
              Text('name: ${tempWorkout.name}', style: Theme.of(context).textTheme.bodyMedium),
              Text('started at: $startTimeStr', style: Theme.of(context).textTheme.bodyMedium),
              Text('duration: ${formatDuration(workoutDuration)}', style: Theme.of(context).textTheme.bodyMedium),
              Text('exercises: $exerciseCount', style: Theme.of(context).textTheme.bodyMedium),
              Text('sets completed: $completedSets / $totalSets', style: Theme.of(context).textTheme.bodyMedium),
              if (setsLeft > 0) 
                Text('sets left: $setsLeft', style: Theme.of(context).textTheme.bodyMedium),
            ],
          ),
        ),
