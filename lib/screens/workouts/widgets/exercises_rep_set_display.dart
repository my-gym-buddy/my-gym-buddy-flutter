...
class _ExercisesRepSetDisplayState extends State<ExercisesRepSetDisplay> {
  ...
  Widget _buildExerciseColumn(int index) {
    return Column(
      key: ValueKey(
          'exercise_${widget.workoutTemplate.exercises![index].name}_$index'),
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            Text(
              widget.workoutTemplate.exercises![index].name.toLowerCase(),
            ...
            atsIconButton(
              ...
              onPressed: () async {
                final bool confirm = await atsConfirmExitDialog(context,
                    ...
                    description:
                        "Are you sure you want to remove exercise-name from this workout session?",
